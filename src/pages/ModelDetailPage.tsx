  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <SectionReveal>
            ...
            <p className="text-xs uppercase tracking-[0.25em] text-emerald-500 mb-4 font-semibold">{model.difficulty}</p>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-[-0.04em] leading-[1.05] mb-4">
              {model.name}
            </h1>
            <p className="text-lg text-white/50 mb-8 max-w-lg mx-auto">{model.description}</p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mb-10">
              ...
              <span className="px-4 py-2 rounded-full bg-white/5 text-white/60 border border-white/10 text-sm">
                {model.difficulty}
              </span>
              <span className="px-4 py-2 rounded-full bg-white/5 text-white/60 border border-white/10 text-sm">
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <SectionReveal className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Hoe het werkt</h2>
          </SectionReveal>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            {/* Dashed connector line */}
            <div className="hidden md:block absolute top-1/2 left-[16.67%] right-[16.67%] h-px border-t border-dashed border-white/10 -translate-y-1/2" />

            {model.steps.map((step, i) => (
              <SectionReveal key={step.title} delay={i * 0.15}>
                <div className="glass-card p-8 text-center relative">
                  <div className="w-10 h-10 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500 font-bold mx-auto mb-4">
                    {i + 1}
                  </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <SectionReveal className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Voordelen</h2>
          </SectionReveal>
            ...
            {model.benefits.map((benefit, i) => (
              <SectionReveal key={benefit} delay={i * 0.1}>
                <div className="glass-card p-8">
                  <Check className="w-6 h-6 text-emerald-500 mb-4" />
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <SectionReveal className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Voor wie is dit?</h2>
          </SectionReveal>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          <SectionReveal className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Verdienpotentieel</h2>
          </SectionReveal>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <SectionReveal className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Andere modellen</h2>
          </SectionReveal>
              ...
              <SectionReveal key={m.slug} delay={i * 0.1}>
                <Link to={`/model/${m.slug}`} className="block">
                  <div className="glass-card p-6">
                    ...
                    <p className="text-sm text-white/50 mb-4">{m.description}</p>
      ...
      <section className="py-24 px-6">
        <SectionReveal>
          ...
          >
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-6">Klaar om te starten met {model.name}?</h2>
