...
export default function TermsPage() {
  return (
    <section className="pt-32 pb-24 px-6">
      <SectionReveal>
        <div className="max-w-[720px] mx-auto prose prose-invert">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-8">Algemene Voorwaarden</h1>
          <p className="text-sm text-white/40 mb-12">HiBOO BV &middot; KvK: 95458751 &middot; BTW: NL866727749B01</p>

          <div className="space-y-10 text-white/60 text-sm leading-relaxed">
            <div>
              <h2 className="text-lg font-semibold text-white mb-3">Artikel 1 — Definities</h2>
              <p>1.1. <strong className="text-white/80">HiBOO:</strong> HiBOO BV, gevestigd in Nederland, ingeschreven bij de Kamer van Koophandel onder nummer 95458751.</p>
              <p className="mt-2">1.2. <strong className="text-white/80">Deelnemer:</strong> De natuurlijke persoon of rechtspersoon die een overeenkomst aangaat met HiBOO voor het afnemen van diensten.</p>
              <p className="mt-2">1.3. <strong className="text-white/80">Diensten:</strong> Alle door HiBOO aangeboden trainingen, cursussen, coaching, digitale producten en overige diensten.</p>
              <p className="mt-2">1.4. <strong className="text-white/80">Overeenkomst:</strong> Elke afspraak of overeenkomst tussen HiBOO en de Deelnemer waarvan deze Algemene Voorwaarden integraal onderdeel uitmaken.</p>
            </div>

            <div>
              <h2 className="text-lg font-semibold text-white mb-3">Artikel 2 — Toepasselijkheid</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-3">Artikel 3 — Diensten</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-3">Artikel 4 — Betalingen</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-3">Artikel 5 — Aansprakelijkheid</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-3">Artikel 6 — Privacy</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-3">Artikel 7 — Toepasselijk recht</h2>
