      ...
      {visible && (
        ...
        >
          ...
          <span className="text-sm text-white/70">
            <strong className="text-white">{count} studenten</strong> hebben zich zojuist aangesloten bij HIBOO
          </span>
    ...
    >
      ...
      >
        <div className="glass-card p-8 text-center">
          <div className="w-32 h-32 mx-auto rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 font-bold text-3xl mb-6">
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="pt-16 pb-12 px-6 text-center max-w-4xl mx-auto">
        <SectionReveal>
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-[-0.03em] leading-tight mb-4">
        ...
        <SectionReveal delay={0.2}>
          <div className="glass-card p-2 !border-emerald-500/20" style={{ boxShadow: '0 0 60px rgba(16,185,129,0.15)' }}>
            <iframe
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <SectionReveal className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Wat studenten bereiken</h2>
          </SectionReveal>
            ...
            {testimonials.map((t, i) => (
              <SectionReveal key={t.name} delay={i * 0.1}>
                ...
                >
                  ...
                  <p className="text-xl font-bold text-emerald-400 mb-3">{t.result}</p>
      ...
      <div className="border-t border-white/[0.06] py-6 text-center">
        <p className="text-xs text-white/30">
          ...
          <a href="/terms" className="hover:text-white/50 transition-colors">Algemene Voorwaarden</a>
        </p>
      </div>
    </div>
  );
